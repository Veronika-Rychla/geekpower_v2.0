...
<Quiz
  id="present-simple-scheduled-future"
  question="Which sentence uses present simple to describe a fixed, scheduled future event, like a timetable?"
  options={[
    { id: "a", text: "I am watching a movie tonight." },
    { id: "b", text: "I will leave soon." },
    { id: "c", text: "The train to Brno leaves at 6:30 tomorrow." },
    { id: "d", text: "She has already left." },
  ]}
  correctId="c"
/>
