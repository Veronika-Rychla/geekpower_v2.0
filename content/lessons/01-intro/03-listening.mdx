...
<Quiz
  id="hyperlinks-purpose"
  question="According to the listening, what do hyperlinks allow the Web to do?"
  options={[
    { id: "a", text: "Load websites faster on slow connections" },
    { id: "b", text: "Organize information in a way that mirrors how our brains connect thoughts" },
    { id: "c", text: "Protect websites from hackers" },
    { id: "d", text: "Automatically translate pages into other languages" },
  ]}
  correctId="b"
/>
