...
<Quiz
  id="ng-sound"
  question="How is the English /ŋ/ sound (as in 'sing') best described?"
  options={[
    { id: "a", text: "A vowel sound" },
    { id: "b", text: "A nasal consonant, like /n/ but produced further back in the mouth" },
    { id: "c", text: "A sound that doesn't exist in spoken English" },
    { id: "d", text: "The same sound as the Czech 'ch'" },
  ]}
  correctId="b"
/>
